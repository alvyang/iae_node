...
router.post("/exportReportComprehensiveAllot",function(req,res){
  ...
  getAllotComprehensive(req).then(data => {
    ...
    conf.name = "mysheet";
    conf.cols = [{caption:'调货单位',type:'string'
    ...
    var header = ['hospitalName', 'allotMoney','allotShouldReturn', 'allotRealReturn', 'allotRealReturn', 'allotNoReturn',
                  'allotReturnMoney','allotReturnMoney0','allotReturnMoney0','allotReturnMoney1'];
    conf.rows = util.formatExcel(header,data.rdTemp);
...
router.post("/exportReportComprehensive",function(req,res){
  ...
  getComprehensive(req).then(data => {
    ...
    conf.stylesXmlFile = "./utils/styles.xml";
    conf.name = "mysheet";
    conf.cols = [{caption:'销售单位',type:'string'
    ...
    var header = ['hospitalName', 'saleMoney','saleMoney0', 'saleMoney0', 'arefundsMoney2', 'refundsMoney2','refundsMoney2','srefundsMoney2',
